...
public class ShopOffersPanelElement extends ShopDraggableScrollableWidgetGroup implements ShopUiElement, WidgetContextRender, UIDisposable {
    ...
    protected void registerDefaultHandlers() {
        ...
        // Register panel-wide default handlers here with listenScreen(...).
        // They survive refresh() and are removed only when ShopScreen is disposed.
    }
