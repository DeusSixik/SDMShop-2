    ...
    private static ShopInstance generate() {
        ...
        builder.addOffer(
                ShopOfferBuilder.builder(RARES_GROUP)
                        ...
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 5))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 7))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 8))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 9))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
                        .addComponent(new ItemRewardComponent(new ItemStack(Items.DRAGON_EGG), 1))
